// build-federal-profile: synthesize federal profile from sources
// Request: { tenant_name: string, sources: [{label, source_type, extracted_text}], prompt_template }
...
export const handler = async (event) => {
  ...
  const { tenant_name, sources = [], prompt_template } = payload
  ...
  const prompt = prompt_template
    ...
    .replace(/\{\{federal_sources\}\}/g, blob || '(no federal sources provided — federal profile cannot be built)')
